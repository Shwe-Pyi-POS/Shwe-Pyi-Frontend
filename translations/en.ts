export const en = {
  ...
  creditPayments: {
    title: "Credit Payment Records",
    subtitle: "View and track all customer credit repayment transactions",
    totalRecords: "Total Records",
    totalCollected: "Total Collected",
    todayCollection: "Today's Collection",
    searchPlaceholder: "Search by Order #, Customer, or Received By...",
    paymentMethod: "Payment Method",
    allMethods: "All Methods",
    dateRange: "Date Range",
    orderNumber: "Order #",
